package com.cloud.similaritycacu

import com.cloud.caseclass.{Simi, Result}
import com.cloud.conf.AppConf
import com.cloud.modeltrain.RecommendForAllUsers._
...
object ItemCF extends AppConf{
  ...
  def main(args: Array[String]) {
    ...
    // 2 读取样本数据
    val data_path = "hdfs://spark1:9000/movie/data/ratings.csv"
